    ...
    <body>
        <div style="background-color: #f9f9f9; padding: 20px; font-family: Arial, sans-serif">
            ...
            >
                ...
                <p>
                    Thanks for signing up for "They Trust Us". Before we get started, please click the button below to
                    verify your email address. This link will expire after 7 days.
                </p>
                <div style="text-align: center; margin: 20px 0">
                    <a
                        href="{{ url('verify-email/' . $user->verification_token) }}"
                        style="
                ...
                <p>
                    <a href="{{ url('verify-email/' . $user->verification_token) }}">
                        {{ url('verify-email/' . $user->verification_token) }}
                    </a>
                </p>
                <p>See you aboard!</p>
