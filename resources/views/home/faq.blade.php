            ...
            <div class="accordion-item">
                ...
                >
                    <div class="accordion-body">
                        ...
                        We allow reviews to be updated if: A substantial amount of additional work has been completed,
                        or The trajectory of the partnership has changed following the original review’s publication
                        Reach out the Theytrustus representative who conducted the initial review. If you no longer know
                        the best point of contact, please reach out to reviews
                        @Theytrustus.co.
                        ...
                        feedback. No original review content, including the quote, will be changed or removed from
                        Theytrustus.co. The original content will be listed at the bottom of the more recent review.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                >
                    <div class="accordion-body">
                        ...
                        <ul>
                            ...
                            <li>
                                Interviews/Client Reviews: Our team will verify and populate your profile with client
                                reviews after receiving client references.
                            </li>
                            <li>Contributed Content: We want to hear about your expertise and thought leadership.</li>
                        </ul>
                    </div>
                    ...
                    <div class="accordion-body">
                        <ul>
                            <li>
                                ...
                                page, not per category.
                            </li>
                            <li>Compared to our competitors, we have a short review process.</li>
                            <li>
                                We collect reviews by directly contacting a company's clients and asking them about
                                their experiences.
                            </li>
                            <li>Our company accepts video testimonials, corporate videos, and portfolio videos.</li>
                        </ul>
                ...
                >
                    <div class="accordion-body">
                        ...
                        <ul>
                            ...
                            <li>Keep in touch with the community.</li>
                            <li>
                                Stay up-to-date, accurate, and consistent with your business or organization's public
                                information.
                            </li>
                            <li>Strengthen the performance and authority of your website.</li>
                        </ul>
