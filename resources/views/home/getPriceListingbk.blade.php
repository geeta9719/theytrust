                            ...
                            <div class="columns">
                                <ul class="price">
                                    ...
                                    <li class="grey">
                                        ...
                                        <button
                                            class="button choose-plan"
                                            data-uid="{{ $user }}"
                                            data-url="{{ url("user/$user/basicInfo?profile=basic") }}"
                                            name="basic"
                                            value="basic"
                                            style="<?php echo $basic; echo $clr1; ?>"
                                        >
                                            Get Started
                                        </button>
                                    </li>
                                ...
                                <ul class="price">
                                    ...
                                    <li class="grey">
                                        ...
                                        <button
                                            class="button choose-plan"
                                            data-uid="{{ $user }}"
                                            data-url="{{ url("user/$user/basicInfo?profile=premium") }}"
                                            name="premium"
                                            value="premium"
                                            style="<?php echo $premium; echo $clr2; ?>"
                                            disabled
                                        >
                                            Coming Soon
                                        </button>
                                    ...
                                    <li>Priority support for Profile, and Verification eligibility</li>
                                </ul>
                            </div>
                                ...
                                <ul class="price">
                                    ...
                                    <li class="grey">
                                        ...
                                        <button
                                            class="button choose-plan"
                                            data-uid="{{ $user }}"
                                            data-url="{{ url("user/$user/basicInfo?profile=sponsorship") }}"
                                            name="sponsorship"
                                            value="sponsorship"
                                            style="<?php echo $sponsorship; echo $clr3; ?>"
                                            disabled
                                        >
                                            Coming Soon
                                        </button>
