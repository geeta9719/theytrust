...
<form id="form2" action="{{ url('companies') }}" method="GET">
	<!--@csrf-->
	<input type="hidden" id="sub" name="services[]" value="<?php if (isset($_GET['services'])) {
	    echo $subcat[0];
	} ?>">
	<input type="hidden" id="loc" name="location[]" value="<?php if (isset($_GET['location'])) {
	    echo $loc[0];
	} ?>">
</form>
					...
					<li class="nav-item dropdown" style="border:1px solid gray; width: 10%;display: inline-block;padding: 2px;">
	                    ...
	                    <div class="dropdown-menu" style="max-height: 300px;overflow-y: scroll;">
							...
							<span class="dropdown-item" href="#" for="location{{$key}}" >
								<input type="checkbox" id="location{{$key}}" name="location[]" onchange="searchCompany()" <?php if (isset($loc) && in_array($key, $loc)) {
								    echo 'checked';
								}?> value="{{$key}}"> {{$location}}
							</span>
							@endforeach
	                ...
	                <li class="nav-item dropdown" style="border:1px solid gray;width: 12%;display: inline-block;padding: 2px;">
	                    ...
	                    <div class="dropdown-menu" style="max-height: 300px;overflow-y: scroll;">
							...
							<span class="dropdown-item" href="#" for="chk_budget{{$budgets}}" >
								<input type="radio" id="chk_budget{{$budgets}}" name="budget" onchange="searchCompany()" <?php if (isset($bud) && $bud == $budgets) {
								    echo 'checked';
	                ...
	                <li class="nav-item dropdown" style="border:1px solid gray;width: 12%;display: inline-block;padding: 2px;">
	                    ...
	                    <div class="dropdown-menu" style="max-height: 300px;overflow-y: scroll;">
							...
							<span class="dropdown-item" href="#" for="rates{{$rates}}" >
								<input type="checkbox" id="rates{{$rates}}" name="rates[]" onchange="searchCompany()" <?php if (isset($rat) && in_array($rates, $rat)) {
								    echo 'checked';
								}?> value="{{$rates}}"> {{$rates}}
							</span>
							@endforeach
...
?>
		            ...
		            <div class="row  ml-0 mr-0 boxbrd pt-0 pb-0">
		                <div class="col-md-2 pt-2 brdright"><!-- pt-3-->
		                    <h4><span><?php if (isset($rate_review[$cmp->id]) && $rate_review[$cmp->id]->review >= 1) {
		                        echo 'Verified';
		                    } ?></span></h4>
