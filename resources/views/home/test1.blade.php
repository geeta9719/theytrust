...
@section('content')
    ...
    <section class="container-fluid list-top">
        <div class="container">
            ...
            <h2>
                Top
                <?php if (! empty($_REQUEST['services'][0])) {
                    ...
                    <div class="inner bg-white p-4 shadow">
                        ...
                        <form id="form2" action="{{ url('directory', [$slug, $place]) }}" method="POST">
                            ...
                            <input
                                ...
                                id="sub"
                                name="services[]"
                                value="<?php if (! empty($_REQUEST['services'][0])) {     echo $subcat[0]; } ?>"
                            />
                            <input
                                type="hidden"
                                id="loc"
                                name="location"
                                value="<?php if (! empty($_REQUEST['location'])) {     echo $loc; } ?>"
                            />
                        </form>
                            ...
                            <div class="filter-box mt-2">
                                <div class="dropbox">
                                    <div class="dropinner">
                                        <select
                                            id="location"
                                            class="location-filter form-control"
                                            name="location"
                                        ...
                                        >
                                            ...
                                            @foreach ($subcategories as $key => $subcategoy)
                                                @if (in_array($key, $subcat))
                                                    <option
                                                        <?php if (isset($subcat) && in_array($key, $subcat)) {     echo 'selected'; } ?>
                                                        value="{{ $key }}"
                                                    >
                                                        {{ $subcategoy }}
                                                    </option>
                                    ...
                                    <div class="dropinner">
                                        ...
                                        >
                                            ...
                                            @foreach ($budget as $b)
                                                ...
                                                <option
                                                    <?php if (isset($bud) && $bud == $b['budget']) {     echo 'selected'; } ?>
                                                    value="{{ $b['budget'] }}"
                                                >
                                                    {{ $budd }}
                                                </option>
                                    ...
                                    <div class="dropinner">
                                        ...
                                        >
                                            ...
                                            @foreach ($rate as $b)
                                                ...
                                                <option
                                                    <?php if (isset($rates) && in_array($b['rate'], $rates)) {     echo 'checked'; } ?>
                                                    value="{{ $b['rate'] }}"
                                                >
                                                    {{ $rr }}
                                                </option>
                                    ...
                                    <div class="dropinner">
                                        ...
                                        >
                                            ...
                                            @foreach ($industry as $key => $indust)
                                                <option
                                                    <?php if (isset($ind) && in_array($key, $ind)) {     echo 'checked'; } ?>
                                                    value="{{ $key }}"
                                                >
                                                    {{ $indust }}
                                                </option>
                                    ...
                                    <div class="dropinner">
                                        ...
                                        >
                                            ...
                                            @foreach ($reviews as $key => $review)
                                                <option
                                                    <?php if (isset($rev) && $rev == $review) {     echo 'checked'; } ?>
                                                    value="{{ $review }}"
                                                >
                                                    {{ $review }}+
                                                </option>
                                    ...
                                    <div class="dropinner">
                                        ...
                                        >
                                            ...
                                            @foreach ($ratings as $key => $rating)
                                                <option
                                                    <?php if (isset($rat) && $rat == $rating) {     echo 'checked'; } ?>
                                                    value="{{ $rating }}"
                                                >
                                                    {{ $rating }}
                                                    <span
                                                    ...
                                                    >
                                                        <img
                                                            src="{{ asset('front_components/images/red.png') }}"
                                                            width="15px;"
                                                        />
                                                    </span>
                                                </option>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="logo-wrapper">
                                ...
                                <div>
                                    <a href=""><h2>Cheenti New Company</h2></a>
                        ...
                        <div class="col-md-5 text-right">
                            <div class="reviews-row">
                                ...
                                <a
                                    href="https://theytrust-us.developmentserver.info/profile/102#reviewsec"
                                    target="_blank"
                                    class=""
                                >
                                    <h3>1 REVIEWS</h3>
                            ...
                            <div class="row mx-0 percentbox">
                                <div class="col-md-4 text-center mb-2 p-2">
                                    <div class="border p-3 w-100 rounded shadow-sm h-100">
                                        <img
                                            src="https://theytrust-us.developmentserver.info/front_components/images/progress.jpg"
                                            alt=""
                                            class="img-fluid"
                                        />
                                        <h3>Advertising</h3>
                ...
                jQuery.ajax({
                    ...
                    success: function (result) {
                        ...
                        window.history.replaceState(
                            '',
                            '',
                            '{{ url('directory') }}/' + t + '/' + loc + '?page=1&' + ser,
                        )
                    },
                })
            }
