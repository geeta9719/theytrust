...
@section('content')
    ...
    <style>
       ...
       .directory-blade .verified-sec a{ display: flex;} 
...
<div class="col-lg-9 col-md-7 firm-sec p-3 mt-4 mt-md-0 shadow directory-blade" id="addCompanyList">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="logo-wrapper">
                               ...
                               <div><img src="https://theytrust-us.developmentserver.info/storage/images/logo/0Y5ThoGAKVrJ6eSaDKLKDub4TlwNJitw7t3QAQ3i.png" alt="" class="img-fluid"></div>
                            <div><a href=""><h2>Cheenti New Company</h2></a>
              ...
              <div class="d-flex"> <a href="">View Porfile</a><a href="">Request Quote</a> </div>
                                            </div>
                                            </div>
                        ...
                        <div class="row mx-0 percentbox">
                            <div class="col-md-4 text-center mb-2 p-2">
                                <div class="border p-3 w-100 rounded shadow-sm h-100">
                                    <img src="https://theytrust-us.developmentserver.info/front_components/images/progress.jpg" alt="" class="img-fluid">
                                    <h3>Advertising</h3>
                                </div>
                            </div>
                            <div class="col-md-4 text-center mb-2 p-2">
                ...
                <div class="container mt-5 agency-sec">
                    ...
                    <p class="expandable-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
