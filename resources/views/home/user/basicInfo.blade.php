            ...
            <div class="col-lg-12  form-size">  
                ...
                <form role="form" name="basicAdd" id="basicAdd" class="" action="{{route('user.saveBasicInfo')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body sheet" id="sheet1">
                        <div class="basicinfo">
                        <h4 class="text-align-center"><strong class="card-title" >Let's get some basic information</strong></h4> 
                        </div>
                       ...
                       <div class="pt-4 col-md-8 file-field uploadbox">
                          ...
                          <div class="upload"><strong style="color: red;"> *</strong>  <input type="file" class="rmvId" id="logo" name="logo">
                            <span class="logocon">(Company Logo should be square jpg, png Format and at least 512 × 512 pixels.) </span></div>
                            <div class="invalid-feedback error1 logo rmvCls">Invalid Image Format!</div>
                        </div> 
                        <div class="pt-4 col-md-4 file-field companylogo" > 
                            <img src="<?php if(!empty($company->logo)){ echo $company->logo;}else{echo asset('front_components/images/logo1.jfif');}?>" width="200" height="auto" style="border-radius:25px;">
                    ...
                    <div class="col-md-12 text-center btnbasic" > <button type="button" class="btn btn-sm btn-primary" onclick="checkValue()">Next</button></div>    
                </form>
