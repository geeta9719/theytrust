                        ...
                        @if($address->count() > 0) 
                            ...
                            <div class="container mt-5 innerformbox">
                                ...
                                <div class="addForm text-black" id="addStatic{{$i}}">
                                    ...
                                    <span style="cursor: pointer;" class="next-btn" onclick="editBtn('addStatic{{$i}}','addForm{{$i}}',{{$i}})" class="next-btn">Edit Your Address</span>
                                </div> 
                                ...
                                <div class="addForm text-black" id="addForm{{$i}}" style="display:none;">
                                    ...
                                    <span style="cursor: pointer;" class="next-btn" onclick="cancelBtn('addForm{{$i}}','addStatic{{$i}}',{{$i}})" class="next-btn">Cancel and Use Location Search</span>
                                </div><br/>
                        ...
                        <div >
                            <div class="container mt-5 innerformbox">
                                ...
                                <div class="addForm text-black" id="addStatic{{$i}}" style="display:none;">
                                    ...
                                    <span style="cursor: pointer;" onclick="editBtn('addStatic{{$i}}','addForm{{$i}}',{{$i}})" class="next-btn">Edit/Update Address</span>
                                </div> <br/>
                                ...
                                <div class="addForm text-black" id="addForm{{$i}}" style="display:none;">
                                    ...
                                    <span style="cursor: pointer;" onclick="cancelBtn('addForm{{$i}}','addStatic{{$i}}',{{$i}})" class="next-btn">Cancel and Use Location Search</span>
                                </div><br/>
