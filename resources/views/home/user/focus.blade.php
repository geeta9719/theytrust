    ...
    <div class="row  ">
        <div class="col-lg-12">
            <div class="col-lg-12  form-size"> 
                ...
                <form role="form" name="focus" id="focus" action="{{route('company.saveFocus')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    ...
                    <div class="row focuspage brdtop brdbottom" >
                        ...
                        <div class="col-md-8 focusleftbox">
                            <h4><strong class="card-title">Service Lines</strong><span style="float:right;">Total = <span id="p1">0</span>%</span></h4>
                    ...
                    <div class="mt-5">  
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" id="frm" style="display:none">Next</button>
                    </div>    
                </form>
            </div>
        </div>        
