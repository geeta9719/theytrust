...
@section('content')
    ...
    <section class="formbox container focuspage">
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-12 form-size">
                    ...
                    <form
                        ...
                        name="focus"
                        id="focus"
                        action="{{ route('company.saveFocus') }}"
                        method="post"
                    ...
                    >
                        ...
                        <div class="row focuspage brdtop brdbottom">
                            <div class="col-md-4 focusleftbox">
                                <h4><strong class="card-title">Add service Line</strong></h4>
                                @foreach ($category as $partent_cat)
                                    <div class="dropdown">
                                        <button class="dropdown-toggle" type="button" data-toggle="dropdown">
                                            {{ $partent_cat->category }}
                                        </button>
                                        <ul class="dropdown-menu">
                                            @foreach ($partent_cat->subcategory as $sub_cat)
                                                <li
                                                    ...
                                                    data-first=""
                                                    data-id="{{ $sub_cat->id }}"
                                                    data-category="{{ $partent_cat->id }}"
                                                >
                                                    <a href="javascript:void(0);">{{ $sub_cat->subcategory }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                            ...
                            <div class="col-md-8 focusleftbox">
                                <h4>
                                    <strong class="card-title">Service Lines</strong>
                                ...
                                <div class="appendService">
                                    ...
                                    @if (! empty($serviceLine))
                                        @foreach ($serviceLine as $service)
                                            ...
                                            <input
                                                type="hidden"
                                                name="service[{{ $service->category_id }}][{{ $service->subcategory_id }}][]"
                                                value="{{ $service->id }}"
                                            />
                                            <div class="serviceA{{ $service->subcategory_id }}">
                                                ...
                                                <div class="row mt-4 ml-2">
                                                    <input
                                                        ...
                                                        id="input_service{{ $service->subcategory_id }}"
                                                        onkeyup="addPercent('service',{{ $service->subcategory_id }},'p1','{{ $service->subcategory->subcategory }}')"
                                                    />
                                                    &nbsp;% &nbsp;&nbsp;
                                                    <strong>{{ $service->subcategory->subcategory }}</strong>
                                                </div>
                                            </div>
                                        @endforeach
                            ...
                            <div class="col-md-4 focusleftbox">
                                <h4 class=""><strong class="card-title">Add Focus Area</strong></h4>
                                @if (! empty($serviceLine))
                                    @foreach ($serviceLine as $service)
                                        @if ($service->percent >= 10)
                                            ...
                                            <div class="dropdown ff focus_{{ $service->subcategory_id }}">
                                                <a
                                                    ...
                                                    class="focuseFirst text-white"
                                                    data-have-val="{{ $sid }}"
                                                    data-has-class=""
                                                    data-first=""
                                                    id="focus_{{ $service->subcategory_id }}"
                                                    onclick="addValue({{ $service->subcategory_id }},'appendFocus')"
                                                >
                                                    {{ $service->subcategory->subcategory }} Focus
                                                </a>
                                            </div>
                                        @endif
                                    @endforeach
                            ...
                            <div class="col-md-8 focusleftbox">
                                <div class="focusPrimary">
                                    <h4><strong class="card-title">Focus Areas</strong></h4>
                                    <!--headF-->
                                    <span class="">
                                        Focus areas help you elaborate on the services your company offers. Choose a
                                        focus group to the left to start adding focuses.
                                    </span>
                                    <!--headT-->
                                </div>
                                            ...
                                            <div class="appendFocus_{{ $key }} appendFocus_all" style="display: none">
                                                <h4 class="focusA_{{ $key }}">
                                                    ...
                                                    @foreach ($adf as $f)
                                                        ...
                                                        <strong class="headF_{{ $key }} card-title">
                                                            {{ $f->subcategory->subcategory }} Focus
                                                        </strong>
                                                        <span style="float: right">
                                                            Total =
                                                            <span id="p2_{{ $key }}">0</span>
                                                            %
                                                        </span>
                                                ...
                                                @foreach ($adf as $f)
                                                    ...
                                                    <input
                                                        type="hidden"
                                                        name="focus[{{ $f->subcategory_id }}][{{ $f->subcat_child_id }}][]"
                                                        value="{{ $f->id }}"
                                                    />
                                                    <div
                                                        class="focusA focusA_{{ $f->subcategory_id }} focusA{{ $f->id }}"
                                                    >
                                                        <input
                                                            type="hidden"
                                                            name="focus[{{ $f->subcategory_id }}][{{ $f->subcat_child_id }}][]"
                                                        ...
                                                        <div class="row mt-4 ml-2">
                                                            <input
                                                                type="text"
                                                                name="focus[{{ $f->subcategory_id }}][{{ $f->subcat_child_id }}][]"
                                                                class="focus input_focus{{ $f->subcategory_id }}"
                                                                data-class="{{ $f->subcategory_id }}"
                                                                value="{{ $f->percent }}"
                                                                id="input_focus{{ $f->subcategory_id }}_{{ $f->id }}"
                                                                onkeyup="addPercent('input_focus{{ $f->subcategory_id }}',{{ $f->subcategory_id }},'p2_{{ $key }}','')"
                                                            />
                                                            &nbsp;% &nbsp;&nbsp;
                                                            <strong>{{ $f->subcat_child->name }}</strong>
                                                        </div>
                                                    </div>
                                                @endforeach

                                                <script>
                                                    $('#p2_{{ $key }}').html({{ $percent }})
                                                </script>
                                            </div>
                                        @endforeach
                                    @endif
                                ...
                                @foreach ($industry as $ind)
                                    <div class="dropdown industry_{{ $ind->id }}">
                                        <a
                                            ...
                                            data-name="industry"
                                            id="industry_{{ $ind->id }}"
                                            onclick="addInd({{ $ind->id }},'industry_{{ $ind->id }}','ind_{{ $ind->id }}','appendIndustry')"
                                        >
                                            {{ $ind->name }}
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-8 focusleftbox">
                                <h4>
                                    <strong class="headI">Industry Focus</strong>
                                    <span style="float: right">
                                        Total =
                                        <span id="p3">0</span>
                                        %
                                ...
                                <div class="appendIndustry">
                                    @if (! empty($addIndustry))
                                        ...
                                        @foreach ($addIndustry as $addI)
                                            ...
                                            <input
                                                type="hidden"
                                                name="industry[{{ $addI->industry_id }}][]"
                                                value="{{ $addI->id }}"
                                            />
                                            <div class="ind_{{ $addI->industry_id }}">
                                                ...
                                                <div class="row mt-4 ml-2">
                                                    <input
                                                        ...
                                                        class="industry"
                                                        value="{{ $addI->percent }}"
                                                        id="input_industry{{ $addI->industry_id }}"
                                                        onkeyup="addPercent('industry',{{ $addI->industry_id }},'p3','')"
                                                    />
                                                    &nbsp;% &nbsp;&nbsp;
                                                    <strong>{{ $addI->industry->name }}</strong>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                @foreach ($clientSize as $client)
                                    <div class="dropdown clientSize_{{ $client->id }}">
                                        <a
                                            ...
                                            data-has-class=""
                                            data-first=""
                                            data-name="clientSize"
                                            id="clientSize_{{ $client->id }}"
                                            onclick="addInd({{ $client->id }},'clientSize_{{ $client->id }}','client_{{ $client->id }}','appendClient')"
                                        >
                                            {{ $client->name }}
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-8 focusleftbox">
                                <h4>
                                    <strong class="headC">Client Size</strong>
                                    <span style="float: right">
                                        Total =
                                        <span id="p4">0</span>
                                        %
                                ...
                                <div class="appendClient">
                                    @if (! empty($addClientSize))
                                        ...
                                        @foreach ($addClientSize as $addI)
                                            ...
                                            <script>
                                                $('#clientSize_{{ $addI->client_size_id }}').attr(
                                                    'data-first',
                                                    'nowHide',
                                                )
                                                $('.clientSize_{{ $addI->client_size_id }}').css(
                                                    'background',
                                                    '#00aff2',
                                                )
                                            </script>
                                            <input
                                                type="hidden"
                                                name="clientSize[{{ $addI->client_size_id }}][]"
                                                value="{{ $addI->id }}"
                                            />
                                            <div class="client_{{ $addI->client_size_id }}">
                                                ...
                                                <div class="row mt-4 ml-2">
                                                    <input
                                                        ...
                                                        class="clientSize"
                                                        value="{{ $addI->percent }}"
                                                        id="input_clientSize{{ $addI->client_size_id }}"
                                                        onkeyup="addPercent('clientSize',{{ $addI->client_size_id }},'p4','')"
                                                    />
                                                    &nbsp;% &nbsp;&nbsp;
                                                    <strong>{{ $addI->client_size->name }}</strong>
                                                </div>
                                            </div>
                                        @endforeach
                            ...
                            <!--
                        <div class="col-md-4 focusleftbox" >
                            <h4 class="">Select Specializations</h4>
                            @foreach ($specialization as $special)

                            <div class="dropdown specialization_{{ $special->id }}">
                                <a href="javascript:void(0)" class="text-white" data-has-class="" data-first="" data-name="specialization" id="specialization_{{ $special->id }}" onclick="addInd({{ $special->id }},'specialization_{{ $special->id }}','special_{{ $special->id }}','appendSpecialization_')">{{ $special->name }}</a>
                            </div>
                            @endforeach

                        </div>
                        <div class="col-md-8 focusleftbox">
                            <h4><strong class="headS">Specializations</strong><span style="float:right;">Total = <span id="p5">0</span>%</span></h4>
                            <span class="headS">Select the specializations that relate to the services you offer.</span>
                            <div class="appendSpecialization_">
                                @if (! empty($addSpecialization))


<?php $percent = 0; ?>

                                    @foreach ($addSpecialization as $addI)


<?php $percent += $addI->percent; ?>

                                        <script>
                                            $("#specialization_{{ $addI->specialization_id }}").attr('data-first','nowHide');
                                            $(".specialization_{{ $addI->specialization_id }}").css('background','#00aff2');
                                        </script>
                                        <input type="hidden" name="specialization[{{ $addI->specialization_id }}][]" value="{{ $addI->id }}">
                                        <div class="special_{{ $addI->specialization_id }}">
                                            <input type="hidden" name="specialization[{{ $addI->specialization_id }}][]" value="{{ $addI->id }}">
                                            <div class="row mt-4 ml-2">
                                                <input type="text" name="specialization[{{ $addI->specialization_id }}][]" class="specialization" value="{{ $addI->percent }}" id="input_specialization{{ $addI->specialization_id }}" onkeyup="addPercent('specialization',{{ $addI->specialization_id }},'p5','')">&nbsp;% &nbsp;&nbsp; <strong> {{ $addI->specialization->name }}</strong>
                                            </div>
                                        </div>
                                    @endforeach

                                    <script> $("#p5").html({{ $percent }}); </script>
                                @endif
                        ...
                        --></div>
                        <div class="mt-5">
                            <a href="{{ route('company.location', $company->id) }}" class="btn btn-sm btn-primary"><</a>
                            <button type="button" class="btn btn-sm btn-primary" onclick="checkValue()">Next</button>
                            <button type="submit" class="btn btn-sm btn-primary" id="frm" style="display: none">
                                Next
                            </button>
                        </div>
                    </form>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.subcategory_list').click(function () {
                ...
                if (hasclass == 'nowHide' || hasFirst == 'nowHide') {
                    ...
                    var html =
                        ...
                        '][' +
                        sub_cat_id +
                        '][]" value="0"><div class="row mt-4 ml-2"> <input type="text" name="service[' +
                        category_id +
                        '][' +
                        sub_cat_id +
                        '][]" class="service" id="input_service' +
                        sub_cat_id +
                        '" onkeyup="addPercent(\'service\',' +
                        sub_cat_id +
                        ",'p1','" +
                        sub_cat_name +
                        '\')" >&nbsp;% &nbsp;&nbsp; <strong>' +
            ...
            addInd = function (idd, idd1, cls, cls1) {
                ...
                if (arrName == 'industry') {
                    var p = 'p3'
                } else if (arrName == 'clientSize') {
                    var p = 'p4'
                } else if (arrName == 'specialization') {
                    var p = 'p5'
                }
                var name = $('#' + idd1).text()
                if (hasclass == 'nowHide' || hasFirst == 'nowHide') {
                    ...
                    html +=
                        ...
                        '[' +
                        idd +
                        '][]" value="0"><div class="row mt-4 ml-2"><input type="text" class="' +
                        arrName +
                        '" name="' +
                        arrName +
                        '[' +
            ...
            addPercent = function (cls, idd, idd1, name) {
                ...
                if (cls == 'service') {
                    ...
                    var a =
                        '<div class="dropdown ff focus_' +
                        idd +
                        '" ><a class=" focuseFirst" style="text-decoratin:none;color:#fff;" data-has-class="" data-first="" data-have-val="0" id="focus_' +
                        idd +
                        '" onclick="addValue(' +
                        idd +
                        ",'appendFocus')\">" +
