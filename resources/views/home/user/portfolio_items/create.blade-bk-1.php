...
<style>
    ...
    .input-container input {
        ...
        /* Padding to the right for the icon */
        font-size: 15px;
    }
...
<div class="container ">
    ...
    <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div id="url_input_div" style="{{ old('media_type') == 'youtube_url' ? 'display:block;' : 'display:none;' }}">
            ...
            <input type="url" name="youtube_url" id="youtube_url" placeholder="Insert YouTube Video URL" value="{{ old('youtube_url') }}" onchange="showPreview(event)">
        </div>
