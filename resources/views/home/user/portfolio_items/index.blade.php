                    ...
                    <div class="row case">
                        <div class="col-md-6 mb-3 details order-2 order-md-1">
                            ...
                            <div class="d-md-flex p-2 mb-2 text-center text-md-left">
                                ...
                                <p>
                                    {{ $item->engagement_start_date->format('F Y') }} -
                                    {{ $item->engagement_end_date->format('F Y') }}
                                </p>
                            </div>
                            <div class="d-md-flex p-2 mb-2 text-center text-md-left">
                                    ...
                                    @if ($item->media)
                                        @if ($item->media['type'] == 'file')
                                            @if (Str::endsWith($item->media['path'], ['.jpg', '.jpeg', '.png']))
                                                <img
                                                    src="{{ asset('storage/' . $item->media['path']) }}"
                                                    alt="Current Image"
                                                />
                                            @elseif (Str::endsWith($item->media['path'], '.pdf'))
                                                <object
                                                    data="{{ asset('storage/' . $item->media['path']) }}"
                                                ...
                                                >
                                                    <p>
                                                        ...
                                                        <a href="{{ asset('storage/' . $item->media['path']) }}">
                                                            Download the PDF
                                                        </a>
                                                        .
                                                    </p>
                                        ...
                                        @elseif ($item->media['type'] == 'youtube')
                                            <iframe
                                                src="https://www.youtube.com/embed/{{ explode('v=', $item->media['url'])[1] }}"
                                                width="100%"
                                                height="500px"
                                                frameborder="0"
