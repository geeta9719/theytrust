...
<link rel="stylesheet" href="https://theytrust-us.developmentserver.info/front_components/css/fontawesome.css">
...
<div class="container">
    <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <option value=""><i style='font-size:24px' class='fas'>&#xf51b;</i> Select Media Type</option>
        ...
        <div id="url_input_div" style="display: none;">
            ...
            <input type="url" name="youtube_url" id="youtube_url" placeholder="Insert YouTube Video URL ( Ex:)" onchange="showPreview(event)">
        </div>
        ...
        <input type="text" name="country_location" id="country_location" placeholder="Country / Location">

        <!-- <label for="services_provided">Services Provided (up to 5 comma separated keywords. 70 characters max)</label> -->
        <input type="text" name="services_provided" id="services_provided" placeholder="Services Provided (up to 5 comma separated keywords. 70 characters max)">

        <!-- <label for="short_description">Short Description</label> -->
        <textarea name="short_description" id="short_description" placeholder="Short Description"></textarea>

        <!-- <label for="engagement_start_date">Engagement Start Date</label> -->
        <input type="date" name="engagement_start_date" id="engagement_start_date" placeholder="Engagement Start Date">

        <!-- <label for="engagement_end_date">Engagement End Date</label> -->
        <input type="date" name="engagement_end_date" id="engagement_end_date" placeholder="Engagement End Date">
