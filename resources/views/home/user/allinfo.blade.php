        ...
        <div class="row">
            <div class="container basicbox">
                ...
                <div class="col-md-10 mx-auto d-flex align-items-center justify-content-between boxcss">
                    <a href="{{ route('user.basicInfo', $uid) }}" class="allinforow">
                        <p>Company Information</p>
                        <i class="fa fa-plus" aria-hidden="true"></i>
                    </a>
                </div>
                <div class="col-md-10 mx-auto mt-4 d-flex align-items-center justify-content-between boxcss">
                    <a href="{{ route('company.location', $company_id) }}" class="allinforow">
                        <p>Locations</p>
                        <i class="fa fa-plus" aria-hidden="true"></i>
                    </a>
                </div>
                <div class="col-md-10 mx-auto mt-4 d-flex align-items-center justify-content-between boxcss">
                    <a href="{{ route('company.focus', $company_id) }}" class="allinforow">
                        <p>Informations</p>
                        <i class="fa fa-plus" aria-hidden="true"></i>
                    </a>
                </div>
