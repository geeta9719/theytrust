            ...
            <div class="row  ml-0 mr-0 company-dec dash-third ">
                <div class="col-md-3 sponsored companybox pt-3">
                    ...
                    <p>
                        ...
                        <!-- <a href="{{route('user.basicInfo',$uid)}}" class="btn btn-sm" style="font-size: 14px;">Update Profile</a> -->
                ...
                <div class="col-md-3 pt-3 sponsored sponsoredright">
                    @if($company->is_publish == 0)
                    <p>We are reviewing your Company Profile at the moment and will publish it soon.
</p>
                    <p>Once your profile gets published, you can map out your performance through this section. 
</p>
                    @endif
                </div>
            </div>
