                                    ...
                                    <div class="register-wrapper-inside">
                                        <div class="step-wrapper step1div">
                                            <div class="stxt text-center">
                                                <a
                                                    href="{{ url('get-listed') }}"
                                                    class="btnlink text-white"
                                                    data-dismiss=""
                                                >
                                                    <strong>Are You Service Provider</strong>
                                                </a>
                                            </div>
                                            <div class="step-number text-center"><strong>OR</strong></div>
                                            <div class="stxt text-center">
                                                <a href="{{ url('/') }}" class="btnlink text-white" data-dismiss="">
                                                    <strong>Looking for Service Provider</strong>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
