            ...
            <div class="col-lg-12">
                <div class="col-lg-12 form-size" id="app">
                    ...
                    <form
                        ...
                        name="marketing"
                        id="marketing"
                        action="{{ route('company.saveAdminInfo') }}"
                        method="post"
                    ...
                    >
                        ...
                        <input
                            type="hidden"
                            name="id"
                            value="<?php if (! empty($adminInfo->id)) {     echo $adminInfo->id; } else {     echo '0'; } ?>"
                        />
                        <input
                            type="hidden"
                            name="company_id"
                            value="<?php if (! empty($adminInfo->company_id)) {     echo $adminInfo->company_id; } else {     echo $company->id; } ?>"
                        />
                        <div class="card-body sheet text-black" id="sheet1">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="email"
                                    name="email"
                                    value="<?php if (! empty($adminInfo->email)) {     echo $adminInfo->email; } ?>"
                                />
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="mobile"
                                    name="mobile"
                                    value="<?php if (! empty($adminInfo->mobile)) {     echo $adminInfo->mobile; } ?>"
                                />
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="linkedin"
                                    name="linkedin"
                                    value="<?php if (! empty($adminInfo->linkedin)) {     echo $adminInfo->linkedin; } ?>"
                                />
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="facebook"
                                    name="facebook"
                                    value="<?php if (! empty($adminInfo->facebook)) {     echo $adminInfo->facebook; } ?>"
                                />
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="twitter"
                                    name="twitter"
                                    value="<?php if (! empty($adminInfo->twitter)) {     echo $adminInfo->twitter; } ?>"
                                />
