                            ...
                            <div class="row mx-auto text-center">
                                <div class="col-md-8 mx-auto text-center">
                                    <div class="register-wrapper-inside">
                                        <p class="reg-summary">
                                            Build your company profile and start collecting client reviews.
                                        </p>
                                        @if (! Auth::check())
                                            <div class="step-wrapper step1div">
                                                ...
                                                <p class="step-text">
                                                    Verify your credentials &amp; create your user account
                                                </p>
...
if (Auth::check() && $profile != '') {
    ?>
                                        ...
                                        <div class="step-wrapper step3div">
                                            ...
                                            <a
                                                href="{{ url("user/$user/basicInfo?$profile") }}"
                                                class="incomplete"
                                                data-step="choose_package"
                                            >
                                                Click Here
