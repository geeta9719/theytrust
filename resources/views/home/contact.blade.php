                    ...
                    <div class="container">
                        ...
                        <form method="POST" action="{{ url('sendContactEmail') }}">
                            ...
                            <div class="form-group">
                                ...
                                <label for="">Services buyer</label>
                                <br />
                                <input type="radio" name="help_options" value="Services Reviewer" />
                                <label for="">Services Reviewer</label>
                                <br />
                                <input type="radio" name="help_options" value="Provider with a TheyTrustUs profile" />
                                <label for="">Provider with a TheyTrustUs profile</label>
                                <br />
                                <input
                                    type="radio"
                                    name="help_options"
                                    value="Establishing a TheyTrustUs Profile as a Service Provider"
                                />
                                <label for="">Establishing a TheyTrustUs Profile as a Service Provider</label>
                                <br />
                            ...
                            <p>
                                <u><b>Let's find an answer together.</b></u>
                            </p>

                            <h6>
                                <b>
                                    Our team will be able to respond to your inquiry more quickly if you provide us with
                                    your contact information and additional details.
                                </b>
                            </h6>
