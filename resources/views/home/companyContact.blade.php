                    ...
                    <div class="container">
                        ...
                        <form method="POST" action="{{ url('sendCompanycontactEmail') }}">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="subject" value="leads" checked />
                                Get a quote/discuss my project needs
                                <label class="form-check-label" for="radio1"></label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="subject" value="partnership" />
                                Propose a partnership opportunity
                                <label class="form-check-label" for="radio2"></label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="subject" value="job_seeker" />
                                Find a job
                                <label class="form-check-label"></label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="subject" value="other" />
                                Other
                                <label class="form-check-label"></label>
                            </div>
                            <span class="text-danger">
