    ...
    <body id="page-top">
                            ...
                            <li class="nav-item">
                                <img
                                    src=" @if (auth()->user()->avatar)
                                        {{ auth()->user()->avatar }}
                                    @else
                                        {{ asset("bower_components/admin-lte/dist/img/AdminLTELogo.png") }}
                                    @endif "
        ...
        >
            <div class="masthead-content">
                <div class="container px-5">
                    @if (! Auth::check())
                        <a href="{{ url("auth/linkedin") }}" class="btn btn-primary text-black">
                            <strong>Login In With LinkedIn</strong>
                        </a>
                        <br />
                        <br />
                    @else
