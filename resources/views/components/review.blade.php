...
<div class="row p-md-4 p-0 sidebar-review-box">
    <div class="col-md-4 greybox">
        ...
        <div class="d-lg-flex userbox">
            <div class="d-lg-flex user-img">
                @php
                    $avatarUrl = $review->user->avatar ?? 'https://theytrust-us.developmentserver.info/front_components/images/logo.png';
    ...
    <div class="col-md-8 tab-box">
        <div class="tabs">
            <ul class="tabs-nav">
                <li>
                    <a href="#tab1-{{ $review->id }}">
                        <i style="font-size: 17px" class="fa">&#xf097;</i>
                        Company Information
                    </a>
                </li>
                <li>
                    <a href="#tab2-{{ $review->id }}">
                        <i style="font-size: 17px" class="fa">&#xf097;</i>
                        Problem Statement
                    </a>
                </li>
                <li>
                    <a href="#tab3-{{ $review->id }}">
                        <i style="font-size: 17px" class="fa">&#xf097;</i>
                        Engagement Details
                    </a>
                </li>
                <li>
                    <a href="#tab4-{{ $review->id }}">
                        <i style="font-size: 17px" class="fa">&#xf097;</i>
                        Success Story
                    </a>
                </li>
            ...
            <div class="tabs-content">
                <div id="tab1-{{ $review->id }}" class="tab-content">
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>Please tell us about your business and what is your role</b>
                    </p>
                    <p class="para-box">{{ $review->company_position }}</p>
                </div>
                <div id="tab2-{{ $review->id }}" class="tab-content">
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>
                            What specific challenges were you facing before working with {{ $review->company->name }}
                        </b>
                    </p>
                    <p class="para-box">{{ $review->for_what_project }}</p>
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>What were your main concerns or pain points related to your project?</b>
                    </p>
                    <p class="para-box">{{ $review->area_of_improvements }}</p>
                </div>
                <div id="tab3-{{ $review->id }}" class="tab-content">
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>Tell us about the project in detail</b>
                    </p>
                    <p class="para-box">{{ $review->scope_of_work }}</p>
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>
                            What services did you receive from {{ $review->company->name }}? For example, Digital
                            Marketing, Web design, Mobile App development.
                        </b>
                    </p>
                    <p class="para-box">{{ $review->how_select }}</p>
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>What factors led to the selection of the vendor</b>
                    </p>
                    <p class="para-box">{{ $review->team_composition }}</p>
                </div>
                <div id="tab4-{{ $review->id }}" class="tab-content">
                    ...
                    <p class="para-box">{{ $review->any_outcome }}</p>
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>
                            In what ways have the services positively impacted your business? (e.g., increased sales,
                            improved brand awareness, enhanced user engagement)
                        </b>
                    </p>
                    <p class="para-box">{{ $review->how_effective }}</p>
                    <p>
                        <i style="font-size: 24px" class="fa">&#xf29c;</i>
                        <b>
                            What were the top 3 things that impressed you the most about the vendor (e.g.,
                            communication, expertise, creativity, process etc)? Is there anything else you would like to
                            share about your experience?
                        </b>
                    </p>
                    <p class="para-box">{{ $review->most_impressive }}</p>
                </div>
            </div>
        </div>
    </div>
