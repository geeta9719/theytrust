                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float: right">
                                ...
                                <a href="{{ route('admin.member.create') }}" class="btn btn-sm btn-primary">
                                    Upload New List
                                </a>
                            </span>
                        </div>
                                    ...
                                    @if ($member->count() > 0)
                                        @foreach ($member as $aboutdirector)
                                            <tr>
                                                ...
                                                <td nowrap>
                                                    <a
                                                        href="{{ route('admin.member.edit', $aboutdirector) }}"
                                                    ...
                                                    @if ($aboutdirector->deleted_at !== null)
                                                        <a
                                                            href="{{ route('admin.member.restore', $aboutdirector) }}"
                                                    ...
                                                    @else
                                                        <form
                                                            method="post"
                                                            action="{{ route('admin.member.destroy', $aboutdirector) }}"
                                                        >
                                                            @csrf
                                                            @method('DELETE')
                                                            <button
                                                                type="submit"
                                                                class="btn btn-sm btn-danger mt-2 show_confirm"
                                                            >
                                                                Delete
                                                            </button>
                                                        </form>
