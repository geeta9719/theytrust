                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float:right;">
                                <a href="{{route('admin.rate.show')}}" class="btn btn-sm btn-primary"> Show </a>
                            </span>
                        </div>                           
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            <div class="col-md-8 editRec" style="margin:0 auto; margin-top:20px; " id="editRec">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <form role="form" action="{{route('admin.rate.update',$rate)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="rate">Rate</label>
                                                <input type="text" class="form-control {{$errors->has('rate') ? 'is-invalid' : ''}}" id="rate" name="rate" value="{{$rate->rate}}">
                                                @error('rate')
