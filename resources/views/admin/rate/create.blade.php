                    ...
                    <div class="card">
                        ...
                        <div class="col-md-8 addNew" style="margin:0 auto; margin-top:20px;;" id="addNew">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form role="form" name="add" id="add" action="{{route('admin.rate.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="rate">Name</label>
                                            <input type="text" class="form-control {{$errors->has('rate') ? 'is-invalid' : ''}}" id="rate" name="rate" >
                                            @error('rate')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
