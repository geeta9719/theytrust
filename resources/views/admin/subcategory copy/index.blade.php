                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input
                                                        type="checkbox"
                                                        name="top_subcat"
                                                        id="top_subcat_{{ $subcategories->id }}"
                                                        class="top_subcat"
                                                        onclick="setPriority({{ $subcategories->id }})"
                                                        title="Make this as TOP Subcategory"
                                                        <?php echo $checked; ?>
                                                    />
                                                </td>
                                                ...
                                                <td nowrap>
                                                    <a
                                                        href="{{ route('admin.subcategory.edit', $subcategories) }}"
                                                    ...
                                                    <form
                                                        method="post"
                                                        action="{{ route('admin.subcategory.destroy', $subcategories) }}"
                                                    >
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
