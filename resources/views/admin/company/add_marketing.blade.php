...
<section class="formbox container mb-5 pb-5">
    <div class="row  ">
        <div class="col-lg-12">
            <div class="col-lg-12  form-size">  
                <!--<form action="/action_page.php" class="was-validated">-->
                <form role="form" name="marketing" id="marketing" action="{{route('admin.company.save-admininfo')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body sheet text-black" id="sheet1">
                        ...
                        <div class="form-group pt-4">
                            ...
                            <small>( This email id will be used for all the communication including leads, alerts etc. )</small>
                            <input type="email" class="form-control rmvId " id="email" name="email" value="{{ !empty( $adminInfo->email ) ? $adminInfo->email : $user_email }}">
                            <div class="invalid-feedback email rmvCls"></div>
                        </div>

                        <div class="form-group">
                            <label for="mobile">Admin Contact Number</label>
