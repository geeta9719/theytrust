        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-lg-12 form-size">
                    ...
                    <form
                        id="comapany_basic_info"
                        class=""
                        action="{{ route('admin.company.save') }}"
                        method="post"
                    ...
                    >
                        ...
                        <h4>
                            <strong class="card-title" style="font-weight: bold">
                                Let's get some basic information about company
                            </strong>
                        </h4>
                        ...
                        <div class="form-group">
                            <label for="website">Website or Company URL (eg: https://example.com)</label>
                            <strong style="color: red">*</strong>
                            <input
                                type="url"
                                class="form-control rmvId"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control rmvId" id="budget" name="budget">
                                ...
                                @foreach ($budgets as $budget)
                                    <option
                                        value="{{ $budget }}"
                                        {{ $company && $budget == $company->budget ? 'selected' : '' }}
                                    >
                                        {{ $budget }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control rmvId" id="rate" name="rate">
                                ...
                                @foreach ($rates as $rate)
                                    <option
                                        value="{{ $rate }}"
                                        {{ $company && $rate == $company->rate ? 'selected' : '' }}
                                    >
                                        {{ $rate }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control rmvId" id="size" name="size">
                                ...
                                @foreach ($sizes as $size)
                                    <option
                                        value="{{ $size }}"
                                        {{ $company && $size == $company->size ? 'selected' : '' }}
                                    >
                                        {{ $size }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control rmvId" id="founded_at" name="founded_at">
                                ...
                                <option
                                    value="{{ $y - $i }}"
                                    {{ $company && $y - $i == $company->founded_at ? 'selected' : '' }}
                                >
                                    {{ $y - $i }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="tagline"
                                name="tagline"
                                value="{{ $company ? $company->tagline : '' }}"
                            />
                            <div class="invalid-feedback tagline rmvCls"></div>
                        </div>

                        <div class="form-group">
                            <label for="short_description">Message</label>
                            <strong style="color: red">*</strong>
                            <textarea
                                ...
                                class="form-control rmvId"
                            >
{{ $company ? $company->short_description : '' }}</textarea
                            >
                        ...
                        <div class="d-flex" style="">
                            ...
                            @if ($company)
                                <a
                                    ...
                                    style="height: 37px; margin-left: 13px"
                                >
                                    >
                                </a>
                            @endif
