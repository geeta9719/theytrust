            ...
            <div class="col-lg-12">
                <div class="col-lg-12 form-size">
                    <form
                        ...
                        name="focus"
                        id="focus"
                        action="{{ route('admin.company.savefocus') }}"
                        method="post"
                    ...
                    >
                        ...
                        <div class="row focuspage brdtop brdbottom">
                            <div class="col-md-4 focusleftbox">
                                <h4 class="mb-4 pb-2">
                                    <strong class="card-title font-weight-bold" style="font-size: 1.5rem">
                                        Add Service Line
                                    </strong>
                                </h4>
                            ...
                            <div class="col-md-8 focusleftbox">
                                <h4>
                                    <strong class="card-title font-weight-bold" style="font-size: 20px">
                                        Service Lines
                                    </strong>
                        ...
                        <div class="mt-5">
                            <a
                                href="{{ route('admin.company.location', [$company->id, $company->user_id]) }}"
                                class="btn btn-md btn-primary"
                            >
                                <
                            </a>

                            <button type="button" class="btn btn-md btn-primary" onclick="checkValue()">
                                Save Focus
                            </button>
                            <button type="submit" class="btn btn-md btn-primary" id="frm" style="display: none">
                                Next
                            </button>

                            <a
                                href="{{ route('admin.company.admininfo', $company->id) }}"
                                class="btn btn-md btn-primary"
                            >
                                >
                            </a>
