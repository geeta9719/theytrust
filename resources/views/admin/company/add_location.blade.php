            ...
            <div class="col-lg-12">
                <div class="col-lg-12 form-size">
                    <form
                        ...
                        name="addLoc"
                        id="addLoc"
                        action="{{ route('admin.company.save-location') }}"
                        method="post"
                    ...
                    >
                                ...
                                <div class="card-body sheet" id="sheet2">
                                    <div class="container mt-5 innerformbox">
                                        ...
                                        <input
                                            type="hidden"
                                            name="is_head_office[]"
                                            value="{{ $add->is_head_office }}"
                                        />

                                        <div class="headquater font-weight-bold" style="font-size: 22px">
                                            {{ $add->is_head_office === 1 ? 'Head Office Location' : 'Additional Office Location' }}
                                        </div>
                                        ...
                                        <div class="addForm text-black" id="addForm">
                                                ...
                                                >
                                                    ...
                                                    @foreach ($states as $state)
                                                        @if ($state->country_code == $add->country_iso2)
                                                            <option
                                                                value="{{ $state->iso2 }}"
                                                                {{ $add->state_iso2 == $state->iso2 ? 'selected' : '' }}
                                                            >
                                                                {{ $state->name }}
                                                            </option>
                                                        @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                >
                                                    ...
                                                    @if ($add->city)
                                                        <option value="{{ $add->city }}" selected="selected">
                                                            {{ $add->city }}
                                                        </option>
                                                    @endif
                                                </select>
                        ...
                        <button type="button" id="addition_address_add" class="btn btn-sm btn-primary">
                        ...
                        <a
                            href="{{ route('admin.company.add', [$user_id, $company_id]) }}"
...
@section('script')
    ...
    <script
        ...
        src="https://maps.google.com/maps/api/js?key=AIzaSyB9YeE5IDfcAUalQ8G26_crBmKoHYvoN5I&libraries=places"
    ></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '#addition_address_add', function () {
                ...
                adtnl_add +=
                    '       <select class="form-control rmvId" id="country' +
                    i +
                    '" name="country_iso2[]" onchange="selectCountry(' +
                    i +
                    ')" required="required">'
                ...
                adtnl_add +=
                    '       <select class="form-control rmvId" id="state' +
                    i +
                    '" name="state_iso2[]" onchange="selectState(' +
                    i +
                    ')" required="required">'
                ...
                adtnl_add +=
                    '       <select class="form-control rmvId" id="city' + i + '" name="city[]" required="required">'
                ...
                adtnl_add +=
                    '       <input type="text" class="form-control rmvId" id="address' +
                    i +
                ...
                adtnl_add +=
                    '    <input type="text" class="form-control rmvId" id="email' +
                    i +
                ...
                adtnl_add +=
                    '    <input type="text" class="form-control rmvId" id="mobile' +
                    i +
