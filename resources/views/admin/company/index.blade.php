                                    ...
                                    @if ($companies->count() > 0)
                                        @foreach ($companies as $company)
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap>
                                                    <a
                                                        href="{{ url('company/' . $company->id . '/dashboard') }}"
                                                    ...
                                                    <a
                                                        href="{{ route('admin.company.add', [$company->user_id, $company->id]) }}"
                                                        class="btn btn-sm btn-primary publishBtn"
                                                    >
                                                        Edit
                                                    </a>
                                                    ...
                                                    <a
                                                        ...
                                                        data-cid="{{ $company->id }}"
                                                        data-flag="{{ $company->is_flagged }}"
                                                        class="btn btn-sm btn-danger isFlag"
                                                    >
                                                        <span id="flag_{{ $company->id }}">{{ $flag_btn_text }}</span>
                                                    </a>

                                                    <a
                                                        href="javascript:void(0)"
                                                        class="btn btn-sm btn-primary publishBtn"
                                                        id="publishBtn_{{ $company->id }}"
                                                        onclick="publish({{ $company->id }})"
                                                    >
                                                        {{ $btnText }}
                                                    </a>
                                                </td>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                ...
                                                |
                                                <a href="javascript:void(0)" class="publishAll" onclick="publishAll(1)">
                                                    Publish
                                                </a>
                                                |
                                                <a href="javascript:void(0)" class="publishAll" onclick="publishAll(0)">
                                                    UnPublish
                                                </a>
                                            </td>
