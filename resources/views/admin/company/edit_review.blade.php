                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form
                                method="POST"
                                action="{{ route('admin.company.update', ['viewreview' => $data['review']->id]) }}"
                            >
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="company_name"
                                        class="form-control"
                                        value="{{ $data['review']->company_name }}"
                                    />
                                </div>
                                    ...
                                    <select class="form-control" id="project_type" name="project_type" required>
                                        ...
                                        @foreach ($data['category'] as $cat)
                                            @foreach ($cat->subcategory as $c)
                                                <option
                                                    value="{{ $c->subcategory }}"
                                                    @if($c->subcategory == $data['review']->project_type) selected @endif
                                                >
                                                    {{ $c->subcategory }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="project_title"
                                        class="form-control"
                                        value="{{ $data['review']->project_title }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control rmvId" id="company_type" name="company_type" required>
                                        ...
                                        @foreach ($data['category'] as $cat)
                                            <option
                                                value="{{ $cat->category }}"
                                                @if($cat->category == $data['review']->company_type) selected @endif
                                            >
                                                {{ $cat->category }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    <label for="cost_range">Project Value Range</label>
                                    <strong style="color: red">*</strong>
                                    <select class="form-control rmvId" id="cost_range" name="cost_range" required>
                                        ...
                                        @foreach ($data['budget'] as $b)
                                            ...
                                            <option
                                                value="{{ $b['budget'] }}"
                                                @if($b['budget'] == $data['review']->cost_range) selected @endif
                                            >
                                                {{ $budget_range }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="project_start"
                                        class="form-control"
                                        value="{{ $data['review']->project_start }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        value="{{ $data['review']->company_position }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="for_what_project"
                                        class="form-control"
                                        value="{{ $data['review']->for_what_project }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="scope_of_work"
                                        class="form-control"
                                        value="{{ $data['review']->scope_of_work }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        value="{{ $data['review']->team_composition }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="any_outcomes"
                                        class="form-control"
                                        value="{{ $data['review']->any_outcomes }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="how_effective"
                                        class="form-control"
                                        value="{{ $data['review']->how_effective }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="most_impressive"
                                        class="form-control"
                                        value="{{ $data['review']->most_impressive }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="area_of_improvements"
                                        class="form-control"
                                        value="{{ $data['review']->area_of_improvements }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="quality_review"
                                        class="form-control"
                                        value="{{ $data['review']->quality_review }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="timeliness_review"
                                        class="form-control"
                                        value="{{ $data['review']->timeliness_review }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        value="{{ $data['review']->communication_review }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="expertise_review"
                                        class="form-control"
                                        value="{{ $data['review']->expertise_review }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        value="{{ $data['review']->ease_of_working }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="ease_of_working_review"
                                        class="form-control"
                                        value="{{ $data['review']->ease_of_working_review }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="refer_ability"
                                        class="form-control"
                                        value="{{ $data['review']->refer_ability }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="refer_ability_review"
                                        class="form-control"
                                        value="{{ $data['review']->refer_ability_review }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="overall_rating"
                                        class="form-control"
                                        value="{{ $data['review']->overall_rating }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        type="text"
                                        name="overall_rating_review"
                                        class="form-control"
                                        value="{{ $data['review']->overall_rating_review }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="position_title"
                                        class="form-control"
                                        value="{{ $data['review']->position_title }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="company_size"
                                        class="form-control"
                                        value="{{ $data['review']->company_size }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="company_email"
                                        class="form-control"
                                        value="{{ $data['review']->company_email }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="phone_number"
                                        class="form-control"
                                        value="{{ $data['review']->phone_number }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="linkedin_url"
                                        class="form-control"
                                        value="{{ $data['review']->linkedin_url }}"
                                    />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="project_summary" class="form-control">
{{ $data['review']->project_summary }}</textarea
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="feedback_summary" class="form-control">
{{ $data['review']->feedback_summary }}</textarea
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="published" class="form-control">
                                        <option value="1" {{ $data['review']->published == 1 ? 'selected' : '' }}>
                                            Published
                                        </option>
                                        <option value="0" {{ $data['review']->published == 0 ? 'selected' : '' }}>
                                            Not Published
                                        </option>
                                    </select>
                                </div>
