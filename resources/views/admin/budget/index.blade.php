                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float:right;">
                                <a href="{{route('admin.budget.create')}}" class="btn btn-sm btn-primary"> Add New</a>
                            </span>
                        </div>                           
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @if($budget->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$budgets->updated_at}}</td>
                                        <td nowrap>
                                            <a href="{{route('admin.budget.edit',$budgets)}}" class="btn btn-sm btn-primary" >Edit</a>
                                            <form method="post" action="{{route('admin.budget.destroy',$budgets)}}" id="sdel">
                                                @csrf
                                                @method('DELETE')
