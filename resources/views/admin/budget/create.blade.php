                    ...
                    <div class="card">
                        ...
                        <div class="col-md-8 addNew" style="margin:0 auto; margin-top:20px;;" id="addNew">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form role="form" name="add" id="add" action="{{route('admin.budget.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="budget">Budget</label>
                                            <input type="text" class="form-control {{$errors->has('budget') ? 'is-invalid' : ''}}" id="budget" name="budget" >
                                            @error('budget')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
