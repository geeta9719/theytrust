                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        <option value="city" {{ old('location_type') == 'city' ? 'selected' : '' }}>
                                            City
                                        </option>
                                        <option value="state" {{ old('location_type') == 'state' ? 'selected' : '' }}>
                                            State
                                        </option>
                                    </select>
                                    @error('location_type')
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        <option value="subskill" {{ old('type') == 'subskill' ? 'selected' : '' }}>
                                            Subskill
                                        </option>
                                    </select>
                                    @error('type')
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        id="data_id"
                                        name="data_id"
                                        class="form-control @error('data_id') is-invalid @enderror"
                                    >
...
@section('script')
    <script>
        ...
        $('#user_id').change(function () {
            ...
            if (userId) {
                $.post(
                    '{{ route('sponce.getCompanies') }}',
                    { user_id: userId, _token: '{{ csrf_token() }}' },
                    function (data) {
