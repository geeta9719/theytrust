                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float: right">
                                <a href="{{ route('admin.attribution.create') }}" class="btn btn-sm btn-primary">
                                    Add New
                                </a>
                            </span>
                        </div>
                                    ...
                                    @if ($attribution->count() > 0)
                                        @foreach ($attribution as $attribute)
                                            <tr>
                                                ...
                                                <td nowrap>
                                                    <a
                                                        href="{{ route('admin.attribution.edit', $attribute) }}"
                                                    ...
                                                    <form
                                                        method="post"
                                                        action="{{ route('admin.attribution.destroy', $attribute) }}"
                                                        id="sdel"
                                                    >
                                                        @csrf
                                                        @method('DELETE')
