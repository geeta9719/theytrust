                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float:right;">
                                <a href="{{route('admin.attribution.create')}}" class="btn btn-sm btn-primary"> Add New</a>
                            </span>
                        </div>                           
                        ...
                        <div class="card-body table-responsive p-0">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @if($attribution->count() > 0)
                                    @foreach($attribution as $attribute)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        ...
                                        <td nowrap>
                                            <a href="{{route('admin.attribution.edit',$attribute)}}" class="btn btn-sm btn-primary" >Edit</a>
                                            <form method="post" action="{{route('admin.attribution.destroy',$attribute)}}" id="sdel">
                                                @csrf
                                                @method('DELETE')
