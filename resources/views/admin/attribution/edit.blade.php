                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            <div class="col-md-8 editRec" style="margin:0 auto; margin-top:20px; " id="editRec">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header" >
                                        <h3 class="card-title" >Update Attribution</h3>
                                    </div>
                                    <!-- form start -->
                                    <form role="form" action="{{route('admin.attribution.update',$attribution)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="name">Name</label>
                                                <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" id="name" name="name" value="{{$attribution->name}}">
                                                @error('name')
