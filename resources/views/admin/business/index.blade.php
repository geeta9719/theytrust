                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float: right">
                                ...
                                <a href="{{ route('admin.business.create') }}" class="btn btn-sm btn-primary">
                                    Add New
                                </a>
                            </span>
                        </div>
                                    ...
                                    @if ($business->count() > 0)
                                        @foreach ($business as $aboutdirector)
                                            <tr>
                                                ...
                                                <td nowrap>
                                                    <a
                                                        href="{{ route('admin.business.edit', $aboutdirector) }}"
                                                    ...
                                                    <form
                                                        method="post"
                                                        action="{{ route('admin.business.destroy', $aboutdirector) }}"
                                                    >
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
