                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float:right;">
                                <a href="{{route('admin.size.create')}}" class="btn btn-sm btn-primary"> Add New</a>
                            </span>
                        </div>                           
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @if($size->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap>
                                            <a href="{{route('admin.size.edit',$sizes)}}" class="btn btn-sm btn-primary" >Edit</a>
                                            <form method="post" action="{{route('admin.size.destroy',$sizes)}}" id="sdel">
                                                @csrf
                                                @method('DELETE')
