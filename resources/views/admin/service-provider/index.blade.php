                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float: right">
                                <a href="{{ route('admin.service-provider.create') }}" class="btn btn-sm btn-primary">
                                    Add New
                                </a>
                            </span>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input
                                                        type="checkbox"
                                                        name="top_service"
                                                        id="top_service_{{ $serviceProvider->id }}"
                                                        class="top_service"
                                                        onclick="setPriority({{ $serviceProvider->id }})"
                                                        title="Make this as TOP Service Provider"
                                                        {{ $checked }}
                                                    />
                                                </td>
                                                ...
                                                <td nowrap>
                                                    <a
                                                        href="{{ route('admin.service-provider.edit', $serviceProvider) }}"
                                                    ...
                                                    <form
                                                        method="post"
                                                        action="{{ route('admin.service-provider.destroy', $serviceProvider) }}"
                                                        id="sdel"
