                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a
                                            href="{{ route('planfeatures.edit', $planFeature->id) }}"
                                            class="btn btn-primary btn-sm"
                                        >
                                            Edit
                                        </a>
                                        <form
                                            action="{{ route('planfeatures.destroy', $planFeature->id) }}"
                                            method="POST"
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                onclick="return confirm('Are you sure you want to delete this plan feature?')"
                                            >
                                                Delete
                                            </button>
                                        </form>
