                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float: right">
                                <a href="{{ route('admin.subcategory-child.show') }}" class="btn btn-sm btn-primary">
                                    Show
                                </a>
                            </span>
                        </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            <div class="col-md-8 editRec" style="margin: 0 auto; margin-top: 20px" id="editRec">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <form
                                        role="form"
                                        action="{{ route('admin.subcategory-child.update', $subcategorychild) }}"
                                        method="post"
