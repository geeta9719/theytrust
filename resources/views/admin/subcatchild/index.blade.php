                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="float: right">
                                <a href="{{ route('admin.subcategory-child.create') }}" class="btn btn-sm btn-primary">
                                    Add New
                                </a>
                            </span>
                        </div>
                                    ...
                                    @if ($subcategorychild->count() > 0)
                                        @foreach ($subcategorychild as $aboutdirector)
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                <td>
                                                    @if ($aboutdirector->subcategory && $aboutdirector->subcategory->subcategory)
                                                        {{ $aboutdirector->subcategory->subcategory }}
                                                    @else
                                                        black
                                                    @endif
                                                </td>
                                                ...
                                                <td nowrap>
                                                    <a
                                                        href="{{ route('admin.subcategory-child.edit', $aboutdirector) }}"
                                                    ...
                                                    <form
                                                        method="post"
                                                        action="{{ route('admin.subcategory-child.destroy', $aboutdirector) }}"
                                                        id="sdel"
                                                    >
                                                        @csrf
                                                        @method('DELETE')
